...
**Versao Atual:** 4.0 (Greenforged Edition)
...
## Novidades da v4.0 (Greenforged Edition)

- **MARCH Obrigatorio** — Atomizacao e validacao cega nao sao opcionais. Sem _resultado_validacao.json, o episodio nao existe.
- **Trava de Balanceamento** — Diferenca maxima de 20% entre speakers. Gate rejeita automaticamente se ultrapassar.
- **Disfluencias Rastreadas** — Cada segmento registra seu contador de interjeicoes. Zero disfluencias = alerta.
- **Granularidade por Segmento** — Estado da obra registra cada um dos 6 segmentos. Retomada exata apos interrupcao.
- **Worktrees Isolados** — Cada episodio em pasta fisica separada. Sem contaminacao de contexto entre episodios.
