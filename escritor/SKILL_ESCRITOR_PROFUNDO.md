...
### 3 a 8 falas por segmento
Uma fala por speaker nao e dialogo, e monologo quebrado alterne entre os speakers naturalmente.
...
| # | Segmento | Funcao | Falas |
|---|----------|--------|-------|
| 1 | Abertura | Gancho | 3-4 |
| 2 | Contexto | Ambientar | 4-6 |
| 3 | Conceito central | Explicar mecanismo | 5-8 |
| 4 | Implicacoes | Traduzir para a vida | 4-6 |
| 5 | Protocolo | Dar acao | 3-5 |
| 6 | Fecho | Sintese + extensao + gancho | 3-4 |
